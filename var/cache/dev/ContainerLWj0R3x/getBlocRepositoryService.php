...
// Returns the private 'App\Repository\BlocRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BlocRepository.php';

return $this->privates['App\\Repository\\BlocRepository'] = new \App\Repository\BlocRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
