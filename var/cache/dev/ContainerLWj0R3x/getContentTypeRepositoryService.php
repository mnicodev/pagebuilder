...
// Returns the private 'App\Repository\ContentTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContentTypeRepository.php';

return $this->privates['App\\Repository\\ContentTypeRepository'] = new \App\Repository\ContentTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
