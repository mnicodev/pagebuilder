...
// Returns the private 'App\Repository\ContentDataRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContentDataRepository.php';

return $this->privates['App\\Repository\\ContentDataRepository'] = new \App\Repository\ContentDataRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
