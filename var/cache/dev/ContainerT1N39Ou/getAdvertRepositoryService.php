...
// Returns the private 'App\Repository\AdvertRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdvertRepository.php';

return $this->privates['App\\Repository\\AdvertRepository'] = new \App\Repository\AdvertRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
