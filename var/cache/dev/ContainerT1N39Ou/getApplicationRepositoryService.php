...
// Returns the private 'App\Repository\ApplicationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ApplicationRepository.php';

return $this->privates['App\\Repository\\ApplicationRepository'] = new \App\Repository\ApplicationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
