...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\PageBuilderController' => 'getPageBuilderControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('W3TH+3d2tT', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H-6bdhx75Q', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AdvertRepository' => ['privates', 'App\\Repository\\AdvertRepository', 'getAdvertRepositoryService.php', true],
            ...
            'App\\Repository\\BlocRepository' => ['privates', 'App\\Repository\\BlocRepository', 'getBlocRepositoryService.php', true],
            'App\\Repository\\BundlePage\\PageRepository' => ['privates', 'App\\Repository\\BundlePage\\PageRepository', 'getPageRepositoryService.php', true],
            'App\\Repository\\ContentDataRepository' => ['privates', 'App\\Repository\\ContentDataRepository', 'getContentDataRepositoryService.php', true],
            'App\\Repository\\ContentRepository' => ['privates', 'App\\Repository\\ContentRepository', 'getContentRepositoryService.php', true],
            'App\\Repository\\ContentTypeRepository' => ['privates', 'App\\Repository\\ContentTypeRepository', 'getContentTypeRepositoryService.php', true],
            'App\\Repository\\FormatZoneRepository' => ['privates', 'App\\Repository\\FormatZoneRepository', 'getFormatZoneRepositoryService.php', true],
            'App\\Repository\\PageRepository' => ['privates', 'App\\Repository\\PageRepository', 'getPageRepository2Service.php', true],
            ...
            'App\\Repository\\BundlePage\\PageRepository' => '?',
            'App\\Repository\\ContentDataRepository' => '?',
            'App\\Repository\\ContentRepository' => '?',
            'App\\Repository\\ContentTypeRepository' => '?',
            'App\\Repository\\FormatZoneRepository' => '?',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_5f6ad2de8dba03bce547ad7082e4e9c017d287b4dd46eb6420e214234376fb17');
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UMB8ZxTD01', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1L6n57NPe+', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yLEbYV0jab', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K-T3BYB4Lt', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s-SbtRdWhk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GDoJaLbk4j', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
