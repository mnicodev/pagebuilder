...
// Returns the private 'App\Repository\FormatZoneRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormatZoneRepository.php';

return $this->privates['App\\Repository\\FormatZoneRepository'] = new \App\Repository\FormatZoneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
