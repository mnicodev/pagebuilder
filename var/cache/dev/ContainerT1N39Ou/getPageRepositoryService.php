...
// Returns the private 'App\Repository\BundlePage\PageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BundlePage/PageRepository.php';

return $this->privates['App\\Repository\\BundlePage\\PageRepository'] = new \App\Repository\BundlePage\PageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
