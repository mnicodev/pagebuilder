 ...
 */
final class Version20191023155200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zone CHANGE id_page_id id_page_id INT DEFAULT NULL, CHANGE position position INT DEFAULT NULL');
