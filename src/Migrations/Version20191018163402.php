 ...
 */
final class Version20191018163402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, id_type_content_id INT DEFAULT NULL, bundle VARCHAR(255) NOT NULL, value LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_FEC530A970FDB640 (id_type_content_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
